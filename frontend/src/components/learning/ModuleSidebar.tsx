...
export const ModuleSidebar: React.FC<ModuleSidebarProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-white border-slate-200 shadow-civic-sm p-5 space-y-4">
        ...
        <div className="block lg:hidden">
          ...
          <select
            ...
            className="w-full px-3.5 py-2 text-xs font-semibold text-slate-900 bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-civic-700/20 focus:border-civic-700 cursor-pointer"
          >
            {modules.map((mod) => (
          ...
          {modules.map((mod, idx) => {
            ...
            return (
              <button
                ...
                className={`w-full text-left p-3 rounded-xl border text-xs transition-all duration-150 flex items-center justify-between gap-2.5 cursor-pointer ${
                  isSelected
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  <span
                    className={`h-6 w-6 rounded-md flex items-center justify-center font-bold text-[11px] shrink-0 ${
      ...
      <Card className="bg-white border-slate-200 shadow-civic-sm p-5 space-y-4">
        ...
        <div className="space-y-3">
          ...
          <Link
            ...
            className="block p-3.5 rounded-xl border border-slate-200 bg-slate-50 hover:bg-blue-50/50 hover:border-civic-300 transition-all group shadow-civic-xs"
          >
            <div className="flex items-center justify-between mb-1.5">
              ...
              <ArrowRight className="h-3.5 w-3.5 text-slate-400 group-hover:text-civic-700 group-hover:translate-x-0.5 transition-all" />
            </div>
          ...
          <Link
            ...
            className="block p-3.5 rounded-xl border border-slate-200 bg-slate-50 hover:bg-emerald-50/50 hover:border-emerald-300 transition-all group shadow-civic-xs"
          >
            <div className="flex items-center justify-between mb-1.5">
      ...
      <Card className="bg-civic-50/60 border-civic-200/80 p-4 shadow-civic-xs space-y-1.5">
