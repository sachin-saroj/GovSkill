...
export const SkillModuleCard: React.FC<SkillModuleCardProps> = ({
  ...
  return (
    <Card
      className="p-5 sm:p-6 flex flex-col justify-between space-y-5 border border-slate-200/90 shadow-civic-sm hover:shadow-civic-md transition-all duration-200 bg-white"
      variant="default"
    >
