...
export const CompetencyInsights: React.FC<CompetencyInsightsProps> = ({
  ...
  return (
    <Card className="border-slate-200 shadow-civic-sm p-6 bg-white space-y-5 rounded-civic-xl">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div className="flex items-center gap-2">
          <TrendingUp className="h-4 w-4 text-civic-700" />
          <h3 className="text-section-heading font-semibold text-slate-900">Workforce Digital Readiness & Competency Signals</h3>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-2 bg-slate-50 p-4 rounded-civic-xl border border-slate-200/80">
          <div className="flex items-center justify-between text-caption">
            <span className="font-semibold text-slate-700">Workforce Certification</span>
            <span className="font-semibold text-civic-900">{certificationRate}% Target</span>
          </div>
        ...
        <div className="space-y-2 bg-slate-50 p-4 rounded-civic-xl border border-slate-200/80">
          <div className="flex items-center justify-between text-caption">
            <span className="font-semibold text-slate-700">Quiz Pass Success Rate</span>
            <span className="font-semibold text-emerald-700">{passRate}% Passed</span>
          </div>
          <div className="w-full bg-slate-200 rounded-full h-2 overflow-hidden">
            <div
        ...
        <div className="space-y-2 bg-slate-50 p-4 rounded-civic-xl border border-slate-200/80">
          <div className="flex items-center justify-between text-caption">
            <span className="font-semibold text-slate-700">Average Quiz Performance</span>
            <span className="font-semibold text-slate-900">{Math.round(avgScore)}% Average</span>
          </div>
          <div className="w-full bg-slate-200 rounded-full h-2 overflow-hidden">
            <div
