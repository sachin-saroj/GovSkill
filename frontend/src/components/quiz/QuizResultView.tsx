...
export const QuizResultView: React.FC<QuizResultViewProps> = ({
  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 sm:px-6 space-y-6 animate-fade-in">
      ...
      <Card className="text-center p-8 sm:p-10 space-y-6 border-slate-200 shadow-civic-md bg-white">
        ...
        <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 max-w-md mx-auto shadow-civic-xs space-y-3">
      ...
      {competency_breakdown && competency_breakdown.length > 0 && (
        <Card className="p-6 sm:p-7 space-y-5 border-slate-200 shadow-civic-sm bg-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {/* Strengths */}
        <Card className="p-5 border-slate-200 shadow-civic-xs bg-emerald-50/40 space-y-3">
        ...
        {/* Weak Areas */}
        <Card className="p-5 border-slate-200 shadow-civic-xs bg-amber-50/40 space-y-3">
      ...
      <div className="p-5 rounded-2xl bg-civic-900 text-white shadow-civic-sm space-y-2">
