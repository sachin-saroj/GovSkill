...
export const QuizPage: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8 space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-3 pt-5 border-t border-slate-200">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            disabled={isSubmitting}
            className="px-6 py-2.5 shadow-civic-sm text-xs"
          >
            {isSubmitting ? (
              <>
