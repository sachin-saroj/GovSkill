...
export const TutorChatPage: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto py-10 px-4 sm:px-6 lg:px-8 space-y-6 animate-fade-in">
      ...
      {/* Active Scope Pill */}
      <div className="flex items-center justify-between px-4 py-2 rounded-xl bg-slate-100/80 border border-slate-200 text-xs text-slate-600">
      ...
      {error && (
        <div className="p-4 rounded-xl bg-red-50 border border-red-300 text-xs text-red-700 flex items-center justify-between gap-2 shadow-civic-xs animate-fade-in">
          <div className="flex items-center gap-2">
          ...
          {lastFailedQuestion && (
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1 bg-white border border-red-300 text-red-800 rounded-md font-bold hover:bg-red-50 text-[11px] cursor-pointer"
            >
