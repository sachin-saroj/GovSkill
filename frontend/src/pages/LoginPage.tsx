    ...
    <div className="min-h-[85vh] flex flex-col items-center justify-center px-4 py-12 bg-slate-50 relative overflow-hidden">
      ...
      >
        ...
        <motion.div variants={fadeUpVariants}>
          <Card className="border-slate-200 shadow-civic-xl p-6 sm:p-8 bg-white/95 backdrop-blur-md rounded-3xl" variant="elevated">
            {/* Header Banner */}
            <div className="text-center mb-6 space-y-2">
              <motion.div
                whileHover={shouldReduceMotion ? {} : { scale: 1.05, rotate: 2 }}
                className="inline-flex p-3.5 rounded-2xl bg-civic-900 text-white shadow-civic-sm mb-1"
              >
            ...
            <AnimatePresence>
              {!isRegister && (
                <motion.div
                  ...
                  className="mb-6 p-3.5 rounded-2xl bg-slate-50 border border-slate-200/90 space-y-2 overflow-hidden shadow-civic-xs"
                >
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <motion.button
                      ...
                      className="px-3 py-2 text-xs font-semibold rounded-xl bg-white border border-slate-200 hover:border-civic-700 text-slate-800 hover:text-civic-800 transition-all flex items-center justify-center gap-1.5 shadow-civic-xs cursor-pointer"
                    >
                    ...
                    <motion.button
                      ...
                      className="px-3 py-2 text-xs font-semibold rounded-xl bg-white border border-slate-200 hover:border-saffron-600 text-slate-800 hover:text-saffron-700 transition-all flex items-center justify-center gap-1.5 shadow-civic-xs cursor-pointer"
                    >
            ...
            <AnimatePresence>
              {error && (
                <motion.div
                  ...
                  className="mb-5 p-3.5 rounded-xl bg-red-50 border border-red-200 text-xs text-red-700 flex items-start gap-2 shadow-civic-xs"
                >
                ...
                {isRegister && (
                  ...
                  >
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-slate-300 bg-white px-3.5 py-2.5 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-civic-700/20 focus:border-civic-700 cursor-pointer"
                    >
        ...
        <motion.div variants={fadeUpVariants}>
          <Link
            to="/citizen"
            className="w-full p-4 bg-emerald-50/70 hover:bg-emerald-50 rounded-2xl border border-emerald-200/90 shadow-civic-xs flex items-center justify-between text-xs transition-all group hover:border-emerald-300 hover:shadow-civic-md"
          >
            <div className="flex items-center gap-3">
              <div className="h-8 w-8 rounded-xl bg-emerald-100 text-emerald-800 flex items-center justify-center shrink-0 shadow-civic-xs group-hover:scale-105 transition-transform">
